...
>
> **AUDIT-ROADMAP (Phase 6) — 🔄 in progress.** New 8-bundle plan from the May 2026 Principal Engineer audit lives at [`docs/roadmap/AUDIT-ROADMAP.md`](./docs/roadmap/AUDIT-ROADMAP.md). Bundle 1 (run persistence + crash recovery: `run_test_results`, `crawl_snapshots`, `dbWriteQueue`, `POST /runs/:id/resume`) ✅ shipped. B2 (iframe + adaptive timeouts) → B3 (reviewer independence) → B4 (auth recovery + target-app TOTP) are the remaining P0 wave; B5 (AUTO-014 — current sprint) → B6 (test quality gates) → B7 (healing safety) follow; B8 (goal-based autonomy, absorbs AUTO-011 + AUTO-021 from queue) is Strategic. **Do not re-list the individual sub-items in the queue** — bundle IDs are the canonical tracking unit; sub-item IDs (RLY-001/005/008, QAL-*, GOL-001, SCL-004) are checklist entries inside each bundle. Target: enterprise readiness 5.5/10 → 8.5/10.
>
...
| Phase 4 — Autonomous Intelligence | Risk-based testing, change detection, quality gates | 🔄 In progress — AUTO-001/002/002b/003/003b/004/005/006/007/008/009/010/012/013/014/015/015b/016/016b/017/017.3/019 ✅ (AUTO-014 shipped in PR #TBD, AUTO-009 in PR #19, AUTO-008 in PR #9, AUTO-010 in PR #6, AUTO-004 in PR #18, AUTO-001 in PR #15); remaining: AUTO-011, AUTO-018, AUTO-021 (AUTO-020 superseded by AUTO-015) · Capabilities row: CAP-001 (data-driven) ✅ PR #1, CAP-002 (sharding) ✅ PR #3; CAP-002b (SaaS-readiness follow-ups) tracked separately in Summary | 14–18 weeks |
...
### AUTO-014 — Test dependency and execution ordering

**Status:** ✅ Complete (PR #TBD) — see Completed Work Summary above for the full implementation details.
